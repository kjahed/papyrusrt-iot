...
public:
    ...
    // Initialize a signal with the src port, id and a data buffer.
    void initialize ( const char * name, Id id, const UMLRTCommsPort * srcPort, const UMLRTObject * const object, uint8_t * data );
