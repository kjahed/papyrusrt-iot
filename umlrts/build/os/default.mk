...
CC_OBJS=\
    ...
    $(BUILDROOT)/$(CONFIG)/umlrt/umlrtmqttcommunicator$(OBJ_EXT) \
	$(BUILDROOT)/$(CONFIG)/umlrt/umlrtnanocommunicator$(OBJ_EXT) \
	$(BUILDROOT)/$(CONFIG)/umlrt/umlrtcoapcommunicator$(OBJ_EXT) \
	$(BUILDROOT)/$(CONFIG)/umlrt/umlrtddscommunicator$(OBJ_EXT) \
